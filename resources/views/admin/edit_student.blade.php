...
<div class="container w-full mx-auto pt-20">
        ...
        <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
            ...
            <div class="div_center">
                    <h2 class="h2_font">Add Student</h2>
            </div>


            <form action="{{url('/edit_student_confirm',$data->id)}}" method="POST"> 
                @csrf
            ...
            <div class="mb-6">
                ...
                required value="{{$data->student_name}}">
            </div>
            ...
            <div class="mb-6">
        <label>Section :</label>
        <select name="section" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
            
            
            <option value="{{ $data->section }}" selected>{{ $data->section }}</option>
            
            @foreach($section as $sectionItem)
            <option value="{{ $sectionItem->section_name }}">{{ $sectionItem->section_name }}</option>
            @endforeach
        </select>
    </div>
    ...
    <div class="mb-6">
        <label>Class :</label>
        <select name="class" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="guardian" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  
                required value="{{$data->guardian_name}}">
            </div>
